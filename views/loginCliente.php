                ...
                <form action="#" method="POST" class="px-2 py-4 border-4 border-gray-600 rounded-lg" >
                    <div>
                        ...
                        <div class="text-center mt-4">
                            <span class="font-bold text-2xl">Iniciar Sesion Cliente</span>
                        </div>
                        <div>
                            ...
                            <div class="flex justify-center">
                                <input type="submit" name="btnValidarCliente" value="Ingresar" class="bg-black hover:bg-blue-700 text-white font-bold py-2 px-4 my-4 rounded-full">
                            </div>
                    </div>
