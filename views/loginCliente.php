                ...
                <form action="#" method="POST" class="bg px-2 py-4 border-4 border-gray-600 rounded-lg" >
                    <div class="">
                        ...
                        <div>
                            ...
                            <div class="flex justify-center">
                                <input type="submit" name="btnValidarCliente" value="Ingresar" class="bg-yellow-500 hover:bg-orange-500 hover:text-white text-gray-800 font-bold py-2 px-4 my-4 rounded-full">
                            </div>
                    </div>
