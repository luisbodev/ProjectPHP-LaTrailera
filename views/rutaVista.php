     ...
     <br>
        ...
        <div class='md:flex'>
          ...
          <div class="w-full md:w-1/2 md:ml-2">
              ...
              <input type="text" class="bg-gray-200 focus:outline-none focus:shadow-outline border-2 border-gray-600 rounded-lg py-2 px-4 block w-full appearance-none leading-normal font-bold" id="kilometrajeReal" name="otro" required placeholder="Kilometraje" readonly>     
          </div>
        ...
        <div class="md:flex">
          ...
          <div class="w-full md:w-1/2 md:ml-2">
            ...
            <div class='relative'>
             ...
             <input type="hidden" id="kilometraje" required name="kilometraje">
            ...
            <br>
            <input type="reset"  class="bg-blue-700 hover:bg-red-800 text-white text-xl mt-2 py-1 px-2 rounded" value="Nuevo" onclick="initMap();$('#g').attr('disabled',false);desactivar()">
