            ...
            <div class="flex items-center justify-between px-2 py-1 md:px-0 md:py-0">
                ...
                <div id="opciones" class="hidden px-1 pb-1 md:flex md:p-0">
                    <?php
                        ...
                        if($currentPage == 'Reportes'){?> <a href='#' class='block mt-1 px-2 font-semibold rounded text-gray-800 bg-gray-200 md:mt-0 md:ml-2'>Reportes</a> <?php } else { ?> <a href='controlReportes.php' class='block mt-1 px-2 text-white font-semibold rounded hover:text-gray-800 hover:bg-gray-200 md:mt-0 md:ml-2'>Reportes</a> <?php }
                    ?>
